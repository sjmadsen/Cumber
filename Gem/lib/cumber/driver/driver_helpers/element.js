...
//    {
//        elements = '[{"Element":' + hashed_elements.join('}, {"Element":') + '}]';
//    }
//
//    var frame = '[{"Origin": [{"X": "' + this.rect().origin.x + '"}, {"Y": "' + this.rect().origin.y + '"}]}, {"Size": [{"Width": "' + this.rect().size.width + '"}, {"Height": "' + this.rect().size.height + '"}]}]';
//    return '[{"Type": "' + this.type() + '"}, {"Label":"' + this.label() + '"}, {"Name": "' + this.name() + '"}, {"Value": "' + this.value() + '"}, {"Frame": ' + frame + '}, {"Child Elements": '+ elements +'}]';
//};
